// ---- Interactive hero name ----
  ...
  nameRender.addEventListener('click', () => nameExtra.focus());
  nameExtra.addEventListener('input', () => {
    // keep it plain text only, no pasted formatting/line breaks
  ...
  const translations = {
    ...
    'hero.tagline': {en:"I build software, then explain it — tutorials, product walkthroughs, and honest reviews for developers who'd rather see the code run than read a spec sheet.",
                     fr:"Je conçois des logiciels, puis je les explique — tutoriels, démonstrations produit et avis honnêtes, pour des développeurs qui préfèrent voir le code tourner plutôt que lire une fiche technique."},
    ...
    'about.p1': {en:'Hi, I\'m Grace — a <span class="hl">frontend developer turned technical content creator</span>. Most UGC creators explain a product\'s vibe. I explain how it actually works, because I\'ve shipped with these tools myself.',
                 fr:'Bonjour, je suis Grace — <span class="hl">développeuse front-end devenue créatrice de contenu technique</span>. La plupart des créateurs UGC expliquent l\'ambiance d\'un produit. Moi, j\'explique comment il fonctionne vraiment, car j\'ai développé avec ces outils moi-même.'},
